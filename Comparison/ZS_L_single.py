...
path = '/Users/anshumansinha/Downloads/HW4_/HW5/630k-best.pt'
...
text_embed = model.get_text_embedding(new_list)
print(text_embed.shape) # (417, 512)

audio_d_list = [d['audio_2'][0] for d in test_dataset] 

#audio_embed = model.get_audio_embedding_from_filelist(x=audio_d_list)
...
with torch.no_grad():
    ...
    #for i in tqdm(range(len(dataset))):
        ...
        audio_embed = model.get_audio_embedding_from_filelist(x=aud_l)
