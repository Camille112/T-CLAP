...
class CLAPWrap():
    ...
    def __init__(self, model, version: str = '2022', use_cuda=False):
        ...
        self.config_as_str = (Path(__file__).parent.parent / f"configs/config_{version}.yml").read_text()
        ...
        if 'roberta' in self.args.text_model or 'clip' in self.args.text_model or 'gpt' in self.args.text_model:
            self.token_keys = ['input_ids', 'attention_mask']
        elif 'bert' in self.args.text_model:
